...
$config = [
    ...
    */
    ...
    'memcache_store.servers' => [
        [
             ['hostname' => 'memcacheda01'],
             ['hostname' => 'memcacheda02'],
        ],
        [
             ['hostname' => 'memcachedb01'],
             ['hostname' => 'memcachedb02'],
        ],
    ],
     ...
     */
    'theme.use' => 'custom-multiauth:custom-multiauth',
